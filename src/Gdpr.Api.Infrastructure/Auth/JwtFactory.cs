...
namespace Gdpr.Api.Infrastructure.Auth
{
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<Token> GenerateEncodedToken(string id, string email, int role)
        {
        ...
        private static ClaimsIdentity GenerateClaimsIdentity(string id, string email, int role)
        {
            return new ClaimsIdentity(new GenericIdentity(id, "Token"), new[]
            {
                new Claim(Helpers.Constants.Strings.JwtClaimIdentifiers.Id, id),
                new Claim(Helpers.Constants.Strings.JwtClaimIdentifiers.Rol, role.ToString())
            });
        }
